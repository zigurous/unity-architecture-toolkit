...
namespace Zigurous.Architecture
{
    ...
    public sealed class ConditionalShowAttribute : ConditionalAttribute
    {
        ...
        public ConditionalShowAttribute(string conditionalField, int enumValue, bool flags = false)
        {
            this.show = true;
            this.conditionalField = conditionalField;
            this.propertyDrawer = PropertyDrawer.Default;
        ...
        public ConditionalShowAttribute(string conditionalField, int[] enumValues)
        {
            this.show = true;
            this.conditionalField = conditionalField;
            this.propertyDrawer = PropertyDrawer.Default;
        ...
        public ConditionalShowAttribute(string conditionalField, float sliderMinValue, float sliderMaxValue)
        {
            this.show = true;
            this.conditionalField = conditionalField;
