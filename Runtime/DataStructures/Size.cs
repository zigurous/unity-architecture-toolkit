...
namespace Zigurous.Architecture
{
    ...
    public struct Size : IEquatable<Size>, IComparable<Size>
    {
        ...
        /// </summary>
        public static Size max => new(int.MaxValue, int.MaxValue);

        /// <summary>
        /// Shorthand for writing <c>Size(2)</c>.
        /// </summary>
        public static Size sq2 => new(2);

        /// <summary>
        /// Shorthand for writing <c>Size(4)</c>.
        /// </summary>
        public static Size sq4 => new(4);

        /// <summary>
        /// Shorthand for writing <c>Size(8)</c>.
        /// </summary>
        public static Size sq8 => new(8);

        /// <summary>
        /// Shorthand for writing <c>Size(16)</c>.
        /// </summary>
        public static Size sq16 => new(16);

        /// <summary>
        /// Shorthand for writing <c>Size(32)</c>.
        /// </summary>
        public static Size sq32 => new(32);

        /// <summary>
        /// Shorthand for writing <c>Size(64)</c>.
        /// </summary>
        public static Size sq64 => new(64);

        /// <summary>
        /// Shorthand for writing <c>Size(128)</c>.
        /// </summary>
        public static Size sq128 => new(128);

        /// <summary>
        /// Shorthand for writing <c>Size(256)</c>.
        /// </summary>
        public static Size sq256 => new(256);

        /// <summary>
        /// Shorthand for writing <c>Size(512)</c>.
        /// </summary>
        public static Size sq512 => new(512);

        /// <summary>
        /// Shorthand for writing <c>Size(1024)</c>.
        /// </summary>
        public static Size sq1024 => new(1024);

        /// <summary>
        /// Shorthand for writing <c>Size(2048)</c>.
        /// </summary>
        public static Size sq2048 => new(2048);

        /// <summary>
        /// Shorthand for writing <c>Size(4096)</c>.
        /// </summary>
        public static Size sq4096 => new(4096);

        /// <summary>
        /// Shorthand for writing <c>Size(8192)</c>.
        /// </summary>
        public static Size sq8192 => new(8192);
        ...
        /// </summary>
        public readonly int Area => Math.Abs(width * height);
        ...
        /// </summary>
        /// <param name="other">The other size to compare to.</param>
        /// <returns>
        ...
        /// </returns>
        public readonly int CompareTo(Size other)
        {
            int a = Area;
            int b = other.Area;
